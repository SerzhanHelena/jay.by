    ...
    return (
      <main>
        <section style={bg} id="main_section1" className={style.main_section}>
          <div className={style.inner}>
            <div className={style.copy}>
              <h1 className={style.main_title}>Jay - легкость в каждом движении</h1>
            </div>
          </div>
        </section>
        {/* <section
        ...
        {/* <section
          id="main_section3"
          // style={{
          //   background: `url(${MainPageBackground2})`,
                ...
                <div className={style.content_wrapper}>
                  <div className={style.item_wrapper}>
                    ...
                    <div className={`${style.item_container} ${style.row2}`}>
                      ...
                      <p className={style.benefits}>
                        Корица - специя, которая по популярности не уступает ни одной
                        другой в кулинарии. Именно эта восточная приправа
                        придает выпечке и десертам неповторимый сладко-древесный
                        аромат. Но не стоит рассматривать ее исключительно в
                        качестве пикантной пряности. В чайной ложке молотой
                        корицы столько же антиоксидантов, сколько и в 150 г
                        черники, а по насыщенности полифенолами молотая корица
                        превосходит все остальные специи.
                      </p>
                    </div>
                    ...
                    <div className={`${style.item_container} ${style.row3}`}>
                      ...
                      <p className={style.benefits}>
                        ...
                        ккал) и гликемическим индексом, равным 0. Именно
                        благодаря этим свойствам продукт просто незаменим для
                        худеющих и лиц, страдающих сахарным диабетом. Регулярное
                        употребление сахарозаменителя способствует нормализации
                        работы многих систем организма, укреплению иммунитета,
